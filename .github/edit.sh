...
insert_text='          [ ${{ matrix.cross_os }} == public_res ] || cd .. \&\& rm -rf sing-box \&\& git clone -b sing-box-b-t-rmz https:\/\/github\.com\/White12352\/sing-box\.git sing-box \&\& rm -rf sing \&\& git clone -b dev-tl-rmz https:\/\/github\.com\/White12352\/sing\.git sing \&\& rm -rf sing-quic \&\& git clone -b dev https:\/\/github\.com\/Mahdi-zarei\/sing-quic sing-quic \&\& git config --global user.email "you@example\.com" \&\& git config --global user.name "Your Name" \&\& cd sjzm\/go\/cmd\/nekobox_core \&\& go mod tidy \&\& cd ../../..' 
